...
export default function Slide04Trend({ index, total }) {
  ...
  return (
    <SlideShell index={index} total={total}>
      ...
      <div className="mt-4 grid lg:grid-cols-3 gap-4 lg:gap-6 flex-1">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="lg:col-span-2 h-64 sm:h-72 lg:h-80"
        >
      ...
      <motion.div
        ...
        className="mt-4 sm:mt-6 grid md:grid-cols-2 gap-3 sm:gap-4"
      >
        <div className="rounded-xl bg-orange-50 border border-orange-200 p-3 sm:p-4 text-orange-800 text-xs sm:text-sm">
        ...
        <div className="rounded-xl bg-brand-50 border border-brand-100 p-3 sm:p-4 text-brand-800 text-xs sm:text-sm">
